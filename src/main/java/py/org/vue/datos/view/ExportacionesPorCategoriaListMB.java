...
public class ExportacionesPorCategoriaListMB extends AbstractListPageBean<Dataset, Integer> {
	...
	public void init() {
		...
		JSONObject json = funciones.getExportacionesPorCategoria(anho + mes);
