...
public class ExportacionesPorPaisListMB extends AbstractListPageBean<Dataset, Integer> {
	...
	private String nombre = "rankingImportaciones"; // "application/json"
	...
	private String mes = "12";
	
	private String anhoHasta = "2008";
	private String mesHasta = "12";
	...
	public void init() {
		...
		JSONObject json = funciones.getExportacionesPorPais(anho + mes, anhoHasta + mesHasta);
