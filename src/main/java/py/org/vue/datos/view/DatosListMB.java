...
public class DatosListMB extends AbstractListPageBean<Dataset, Integer> {
	...
	public void init() {
		...
		JSONObject json = funciones.getImportacionesPorAnho("%");
					...
					for (Iterator<String> it = filters.keySet().iterator(); it
						...
						try {
							...
							String filterValue = (String) filters
									.get(filterProperty);
							String fieldValue = String.valueOf(objeto
									.get(filterProperty.substring(5,
